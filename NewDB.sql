CREATE DATABASE  IF NOT EXISTS `cleardb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `cleardb`;
...
INSERT INTO `students` VALUES (1,'Яковлев Александр Васильевич','4011','Разработка клиентской части веб-сервиса для сопровождения защит ВКР','Потемкина Снежана Владиславовна',4.4,'возможно','2024','ИВТ');
